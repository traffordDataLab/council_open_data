...
df <- df_raw %>%
  ...
  mutate(`Total identified fraud` = NA,
         `Value fraud` = NA,
         `Value fraud recovered` = NA,
         `Total investigated irregularities` = NA,
         `Total identified irregularities` = NA,
         `Value irregularities` = NA,
         `Value irregularities recovered` = NA)

...
*Locations and details of the 6 Community Hubs across Trafford.*
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    <td><a href="https://www.trafford.gov.uk/residents/community/Community-Response-Hubs.aspx" target="_blank">Trafford Council</a></td>
    <td><a href="https://www.trafforddatalab.io/council_open_data/assets/community_hubs" target="_blank">Trafford Council</a></td>
    <td>N/A</td>
    <td>Point data</td>
    ...
    <td><time datetime="2024-02-02">2024-02-02</time></td>
  </tr>
</table>

<h2>Preview</h2>
Sort, filter and export a selection of the data using the table. An <a href="https://www.trafforddatalab.io/explore/#dataset=community_hubs" target="_blank">interactive map</a> is also available.
...
```
<div id="tableFooterTitle">Community Hubs in Trafford</div>
...
|File name |Format |
|---|---|
|[trafford_community_hubs.csv](trafford_community_hubs.csv) |CSV |
|[trafford_community_hubs.geojson](trafford_community_hubs.geojson) |GeoJSON |
